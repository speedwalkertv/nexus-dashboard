...
export function Faq() {
  return (
    <section className="bg-creme-200 py-20 sm:py-24">
      <div className="container-x grid gap-10 lg:grid-cols-[20rem_1fr] lg:gap-16">
        ...
        <Reveal delay={0.08}>
          <div className="divide-y divide-creme-300 border-y border-creme-300">
            {perguntas.map((item) => (
              <details key={item.pergunta} className="group py-5">
                <summary className="flex cursor-pointer list-none items-start justify-between gap-6 text-ink marker:hidden">
